...
const eventTimer = () => {
    setEventDate: '';
    _eventDate: new Date('May 7, 2018 14:00:00').getTime();
    _now: new Date().getTime();
    _distance: eventDate - now;
    _day: Math.floor(distance / (1000 * 60 * 60 * 24));
    _hour: Math.floor((distance % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60));
    _min: Math.floor((distance % (1000 * 60 * 60)) / (1000 * 60));
    _sec: Math.floor((distance % (1000 * 60)) / 1000);
} 
